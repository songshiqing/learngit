...
<body>
<center>
    <div class="location">当前位置: > <a href="/2017-6-1/full/index.php/Home/Index/index">分类列表</a>  > <a href="/2017-6-1/full/index.php/Home/Index/add">添加分类</a>  </div>
    <h2 class="t2"><?php if($action == 'add'): ?>新增<?php else: ?>编辑<?php endif; ?>分类</h2>
    <form enctype="multipart/form-data" action="/2017-6-1/full/index.php/Home/Index/<?php echo ($action); ?>" method="post">
